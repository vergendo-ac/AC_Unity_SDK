...
public class AssetLoader : MonoBehaviour
{
    ...
    public void StartLoadAB()
    {
        ...
        else
        {
            ...
            //foreach (AssetBundle ab in modelManager.bundles) //FixMe: not this?
            allBundles = modelManager.bundles.ToArray();
            foreach (AssetBundle ab in allBundles)
            {
    ...
    IEnumerator LoadAsset()
    {
        ...
        else Debug.Log("Check asset name");
        */

        BundleFullURL = ServerUrlsNs.URLSData.Instance.URLs.GetMediaURL(ABName);
