...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LocalizerLocalizeDescription :  IEquatable<LocalizerLocalizeDescription>, IValidatableObject
    {
        ...
        public LocalizerLocalizeDescription(LocalizerLocalizeDescriptionGps gps = default(LocalizerLocalizeDescriptionGps), int focalLengthIn35mmFilm = default(int), ModelBool mirrored = default(ModelBool), RotationEnum? rotation = RotationEnum.NUMBER_0)
        {
        ...
        public ModelBool Mirrored { get; set; }
