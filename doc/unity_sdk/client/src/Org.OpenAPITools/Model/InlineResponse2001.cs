...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(InlineResponse2001Status status = default(InlineResponse2001Status))
        {
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for InlineResponse2001 and cannot be null");
        }
        ...
        public InlineResponse2001Status Status { get; set; }
