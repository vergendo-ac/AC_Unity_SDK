...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        public InlineObject4(LocalizerLocalizeDescription description = default(LocalizerLocalizeDescription), System.IO.Stream image = default(System.IO.Stream))
        {
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for InlineObject4 and cannot be null");
            // to ensure "image" is required (not null)
            this.Image = image ?? throw new ArgumentNullException("image is a required property for InlineObject4 and cannot be null");
        }
