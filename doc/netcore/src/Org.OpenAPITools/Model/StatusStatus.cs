...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatusStatus :  IEquatable<StatusStatus>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusStatus" /> class.
        /// </summary>
        ...
        public StatusStatus(CodeEnum code = default(CodeEnum), string message = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as StatusStatus);
        }

        /// <summary>
        /// Returns true if StatusStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusStatus input)
        {
            if (input == null)
                return false;
